...
public class PowerWidget extends FrameLayout {
    ...
    private static final String BUTTONS_DEFAULT = PowerButton.BUTTON_WIFI + BUTTON_DELIMITER
            + PowerButton.BUTTON_BLUETOOTH + BUTTON_DELIMITER + PowerButton.BUTTON_GPS
    ...
    public void setupWidget() {
        ...
        if (buttonCount > LAYOUT_SCROLL_BUTTON_THRESHOLD) {
            ...
            // scrollbar, so we don't have them overlap
    ...
    private class WidgetSettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.EXPANDED_HAPTIC_FEEDBACK), false,
                    this);
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.EXPANDED_VIEW_WIDGET_COLOR), false,
                    this);
