...
public class PageView extends BounceSwipeView
{
    ...
    private OnPageChangedListener mOnPageChangedListener; // as we are
                                                          // implementing our
                                                          // own
    ...
    /**
     * The page being shown on the screen, rather than the underlying page in
     * the SwipeView structure ( getCurrentPage() )
     * 
     * @return
     */
    ...
    // we call this locally because we do a sneaky sneaky for 2 pages. we double
    // it so it behave like it has four pages instead e.g. [1][2] becomes
    // [1][2][1][2]. We then correct for this in the loadPage method
    ...
    private void fillCarousel(int page)
    {
        ...
        if (mAdapter.getCount() == 1)
        {
            loadPage(0, 0, null);// TODO make this actually support one page
                                 // only.
        }
        ...
        {
            if (page == 0 && mCarouselMode)// if first page, need to handle
                                           // loading last page
            {
            ...
            else if (page == mAdapter.getCount() - 1 && mCarouselMode)// if last
                                                                      // page,
                                                                      // need to
                                                                      // handle
                                                                      // loading
    ...
    {
        // call the OnPageChangedListener that might have been set by a class
        // implementing a PageView
        if (mOnPageChangedListener != null)
        {
            if (mCarouselMode && mCurrentPage == 0 && newPage == 2) // looping
                                                                    // round to
                                                                    // end from
                                                                    // begining
            {
            ...
            else if (mCarouselMode && mCurrentPage == mAdapter.getCount() - 1 && newPage == 0) // looping
                                                                                               // round
                                                                                               // from
                                                                                               // end
                                                                                               // back
            ...
            else if (!mCarouselMode && mCurrentPage == 1 && newPage == 1) // going
                                                                          // from
                                                                          // first
                                                                          // page
                                                                          // into
            ...
            else if (!mCarouselMode && mCurrentPage == mAdapter.getCount() - 1
                    && newPage == mAdapter.getCount() - 1)
            {
    ...
    private void refill(int position)
    {
        ...
        {
            if (position == getAdapterPageCount() - 1 || position <= mCurrentPage + 1)// if
                                                                                      // we
                                                                                      // need
                                                                                      // to
                                                                                      // refill
        ...
        else if (mCurrentPage == getAdapterPageCount() - 1)// if it could be an
                                                           // edge case at end
        {
            if (position >= mCurrentPage || position == 0)// if we need to
                                                          // refill carousel
            {
                fillCarousel(mCurrentPage);
            }
        ...
        {
            if (position >= mCurrentPage - 1 && position <= mCurrentPage + 1)// if
                                                                             // we
                                                                             // need
                                                                             // to
                                                                             // refill
